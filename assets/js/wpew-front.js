...
jQuery(document).ready(function($){
    ...
    function myTimer() {
        ...
        $("#timer").html(
            ...
            "<li class='list-inline-item hours'>" +
            days +
            "</li><li class='list-inline-item'><span class='seperator'>:</span></li>" +
            "<li class='list-inline-item hours'>" +
            hours +
            "</li><li class='list-inline-item'><span class='seperator'>:</span></li>" +
            "<li class='list-inline-item minutes'>" +
            minutes +
            "</li><li class='list-inline-item'><span class='seperator'>:</span></li>" +
            "<li class='list-inline-item seconds'>" +
            seconds +
            "</li>"
        );
    }
